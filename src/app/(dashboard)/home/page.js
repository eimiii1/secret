...
function Navbar() {
  ...
  return (
    <nav
      className="sticky top-0 z-50 w-full border-b-2 border-black"
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-20">
        ...
        <div className="flex flex-col gap-4">
          ...
          <h1
            className="text-7xl md:text-8xl font-black leading-none text-black"
            style={{ fontFamily: "serif" }}
          >
            HI,
            <br />
          ...
          {/* marquee strip */}
          <div
            className="mt-6 bg-black text-white text-xs font-bold uppercase tracking-widest py-2 overflow-hidden whitespace-nowrap"
            style={{ transform: "rotate(-1deg)" }}
          >
            <span className="inline-block animate-marquee">
              nagngangawngaw yan lods solid high protein parang makahiya android
              pa grabe
            </span>
          </div>
        </div>
        ...
        <div className="flex justify-center items-center relative">
          ...
          {/* decorative sticker */}
          <div
            className="absolute -top-4 -right-4 bg-rose-400 text-white text-xs font-black px-3 py-1 rounded-full border-2 border-black"
